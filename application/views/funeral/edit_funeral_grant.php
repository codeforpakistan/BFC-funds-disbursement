                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" autocomplete="off" value="<?php echo $all['dependent_death_date']; ?>" name="dependent_death_date" id="dependent_death_date" class="form-control validate[required]" placeholder="Enter <?php echo $label; ?>" />
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="bank_type_id" id="bank_type_id" class="form-control select2 validate[required]">
                                            ...
                                            <?php foreach ($bank_types as $bank) : ?>
                                                <option value="<?php echo $bank['id']; ?>" <? if($all['tbl_banks_id'] == $bank['id']) { echo 'selected'; } ?>><?php echo $bank['name']; ?></option>
                                            <?php endforeach; ?>
                                        </select> 
