            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" autocomplete="off" value="<?php echo $all['contact_no']; ?>" name="contact_no" id="contact_no" maxlength="11" class="form-control validate[required,minSize[3],custom[number]" placeholder="Enter <?php echo $label; ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input <?php if ($all['marital_status'] == 'married') {
                                                echo 'checked="checked"';
                                            } ?> type="radio" class="validate[required]" name="marital_status" id="marital_status" value="married"> Married
                                    <input <?php if ($all['marital_status'] == 'unmarried') {
                                                echo 'checked="checked"';
                                            } ?> type="radio" class="validate[required]" name="marital_status" id="marital_status" value="unmarried"> Unmarried
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" autocomplete="off" value="<?php echo $all['cnic_no']; ?>" maxlength="13" name="cnic_no" id="cnic_no" class="form-control validate[required,minSize[13],maxSize[13],custom[number]" placeholder="Enter <?php echo $label; ?>" />
                    ...
                    <i class="fa fa-check"></i>
                                        ...
                                        <input <?php if ($all['status'] == '1') {
                                                    echo 'checked="checked"';
                                                } ?> type="radio" name="status" value="1"> Active
                                        <input <?php if ($all['status'] == '0') {
                                                    echo 'checked="checked"';
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="tbl_department_id" id="tbl_department_id" class="form-control select2 validate[required]">
                                            ...
                                            <?php foreach ($department as $departmentInfo) : ?>
                                                <option <?php if ($all['tbl_department_id'] == $departmentInfo['id']) {
                                                            echo 'selected="selected"';
                                                        } ?> value="<?php echo $departmentInfo['id']; ?>"><?php echo $departmentInfo['name']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="tbl_post_id" id="tbl_post_id" class="form-control select2 validate[required]">
                                            ...
                                            <?php foreach ($post as $postInfo) : ?>
                                                <option <?php if ($all['tbl_post_id'] == $postInfo['id']) {
                                                            echo 'selected="selected"';
                                                        } ?> value="<?php echo $postInfo['id']; ?>"><?php echo $postInfo['name']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="tbl_district_id" id="tbl_district_id" class="form-control select2 validate[required]">
                                            ...
                                            <?php foreach ($district as $districtInfo) : ?>
                                                <option <?php if ($all['tbl_district_id'] == $districtInfo['id']) {
                                                            echo 'selected="selected"';
                                                        } ?> value="<?php echo $districtInfo['id']; ?>"><?php echo $districtInfo['name']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
